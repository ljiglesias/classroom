...
{
	PORTC |= (1 << PORTC5); //Rojo no sacar
	PORTC &= ~(1 << PORTC4);	 //verde si se puede sacar
	BYTE fmt, buf[36];
...
)
{
	...
	*bw = 0;
	...
	PORTC &= ~(1 << PORTC5); //Rojo sacar
	 //verde si puede sacar
	return FR_OK;
}
#endif
...
)
{
	...
	PORTC |= (1 << PORTC5); //Rojo sacar
	PORTC &= ~(1 << PORTC4);	 //verde si puede sacar
	CLUST clst;
