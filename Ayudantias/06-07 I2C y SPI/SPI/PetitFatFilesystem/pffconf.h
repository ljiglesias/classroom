...
/* Disabled for SEP course, because the macros defined in pff.h for word
 * access break the strict aliasing rules introduced in gcc a while ago.
 * This could be fixed with nice union definitions, but this way was faster
